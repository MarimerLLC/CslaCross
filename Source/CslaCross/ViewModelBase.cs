...
namespace CslaCross
{
    public abstract class ViewModelBase<T> : MvxViewModel, IViewModel
    {
        #region Constructor
        ...
        private void SetProperties()
        {
            ...
            if (targetObject != null)
            {
                ...
                else
                {
                    ...
                    {
                        CanRemove = Csla.Rules.BusinessRules.HasPermission(AuthorizationActions.DeleteObject, itemType) &&
                                    list.Count > 0 && !isObjectBusy;

                        CanAddNew = Csla.Rules.BusinessRules.HasPermission(AuthorizationActions.CreateObject, itemType) &&
                                    !isObjectBusy;
                    }
                }
            }
        ...
        protected virtual async System.Threading.Tasks.Task<T> SaveAsync()
        {
            try
            {
                ...
                if (ManageObjectLifetime)
                {
                    ...
                    Csla.ICloneable clonable = Model as Csla.ICloneable;
#else
                    ICloneable clonable = Model as ICloneable;
#endif
                    if (clonable != null)
    ...
    protected virtual void BeginAddNew()
    {
      ...
      OnSetProperties();
        ...
        /// </summary>
        public event System.ComponentModel.PropertyChangedEventHandler PropertyChangedHandler;
        ...
        protected virtual void OnPropertyChanged(string propertyName)
        {
            if (PropertyChangedHandler != null)
                PropertyChangedHandler(this, new System.ComponentModel.PropertyChangedEventArgs(propertyName));
        }
        ...
        {
            var npc = model as System.ComponentModel.INotifyPropertyChanged;
            if (npc != null)
